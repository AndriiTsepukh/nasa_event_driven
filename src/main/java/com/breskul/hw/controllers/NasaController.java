...
import com.breskul.hw.controllers.entity.Photos;
...
public class NasaController {
    ...
    Logger logger = LoggerFactory.getLogger(NasaController.class);

    final String url = "https://api.nasa.gov/mars-photos/api/v1/rovers/curiosity/photos";
    RestTemplate restTemplate = new RestTemplate();

    public byte[] getLargestPicture(int sol, Optional<String> camera) {
        ...
        logger.info("Pictures qty: " + imgSrc.size());
